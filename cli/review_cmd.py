...
async def cmd_review(pr_number: int, branch: str = None):
    ...
    console.print(Panel(
        ...
        f"Agents run: {len(risk_report.agents_run)}  |  "
        f"Findings: {len(valid_findings)}",
        title="Risk Report",
        border_style="blue",
    ))
    ...
    console.print()
    console.print(f"[dim]Task ID: TASK-PR{pr_number} — run 'reflect' to accept/reject findings[/dim]")
    console.print()
